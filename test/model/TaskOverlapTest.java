...
public class TaskOverlapTest {
    ...
    @Test
    public void isTasksOverlapping_shouldDetectOverlap() {
        // given
    ...
    @Test
    public void isTasksOverlapping_shouldNotDetectOverlapForNonOverlappingTasks() {
        // given
        Task task1 = new Task("Задача 1", "Описание", Duration.ofHours(2),
                LocalDateTime.of(2024, 1, 15, 10, 0)); // 10:00-12:00
        task1.setId(1);
    ...
    @Test
    public void isTasksOverlapping_shouldNotDetectOverlapForAdjacentTasks() {
    ...
    @Test
    public void updateTask_shouldThrowExceptionForOverlappingTasks() {
        // given
    ...
    @Test
    public void updateTask_shouldAllowNonOverlappingTasks() {
        // given
        int taskId1 = manager.createTask("Первая задача", "Описание");
        var firstTaskOpt = manager.getTask(taskId1);
        assertTrue(firstTaskOpt.isPresent());
    ...
    @Test
    public void isTasksOverlapping_shouldNotDetectOverlapForTasksWithoutTime() {
        // given
